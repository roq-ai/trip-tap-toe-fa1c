...
export function TravelPlanListPage(props: TravelPlanListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getTravelPlans({
        relations: ['organization', 'user', 'budget_allocation.count'],
        limit: params.pageSize,
        offset: params.pageNumber * params.pageSize,
        searchTerm: params.searchTerm,
        order: params.order,
        searchTermKeys: ['destination.contains', 'status.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('budget_allocation', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'budget_allocation',
          header: 'Budget Allocation',
          accessorKey: 'budget_allocation',
          cell: ({ row: { original: record } }: any) => record?._count?.budget_allocation,
        }
      : null,
