...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Trip Tap Toe  `}</title>

        <meta
          name="description"
          content="Welcome to Trip Tap Toe - Your Ultimate Destination for Enterprise Travel PaaS, Streamlining Your Business Travel Needs Efficiently."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxlbnRlcnByaXNlfGVufDB8fHx8MTY5NDQ4OTcxMXww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Trip Tap Toe - Your Ultimate Destination for Enterprise Travel PaaS, Streamlining Your Business Travel Needs Efficiently.`}
            </Text>
            <Box
