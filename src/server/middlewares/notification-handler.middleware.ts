...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'travel_plan.create': {
    roles: ['administrator', 'travel-manager', 'finance-manager'],
    key: 'travel-plan-created',
    tenantPath: ['organization', 'travel_plan'],
    userPath: [],
  },
  'travel_plan.update': {
    roles: ['administrator', 'travel-manager', 'finance-manager'],
    key: 'travel-plan-updated',
    tenantPath: ['organization', 'travel_plan'],
    userPath: [],
  },
  'budget_allocation.update': {
    roles: ['administrator', 'finance-manager'],
    key: 'budget-allocation-updated',
    tenantPath: ['organization', 'travel_plan', 'budget_allocation'],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['administrator', 'travel-manager', 'employee', 'finance-manager'];
